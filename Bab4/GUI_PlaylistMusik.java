...
public class GUI_PlaylistMusik extends javax.swing.JFrame {
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        /// Cetak data menggunakan getter
        memoCTK.append("Playlist Musik\n");
        memoCTK.append("--------------------------------------------------------\n");
        memoCTK.append("Nama        : " + playlist.getNama() + "\n");
        memoCTK.append("Email       : " + playlist.getEmail() + "\n");
        memoCTK.append("Judul Lagu  : " + playlist.getJudulLagu() + "\n");
        memoCTK.append("Artis       : " + playlist.getArtis() + "\n");
        memoCTK.append("Genre       : " + playlist.getGenre() + "\n");
        memoCTK.append("Rating      : " + playlist.getRating() + "/5.0\n");
