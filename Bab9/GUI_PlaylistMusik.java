...
public class GUI_PlaylistMusik extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (rating < 0.0 || rating > 5.0) {
            throw new IllegalArgumentException("Rating harus dalam rentang 0.0 sampai 5.0");
        }
        
        DataPlaylist playlist = new DataPlaylist(nama, email, judulLagu, artis, genre, rating);
        playlist.tampilkanPlaylist(); // Menampilkan info ke console
        ...
        JOptionPane.showMessageDialog(this, "Input rating harus berupa angka.", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (IllegalArgumentException e) {
            JOptionPane.showMessageDialog(this, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Terjadi kesalahan tidak terduga: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
